...
<div class="main-container <?php print $container_class; ?>">
  ...
  <div class="row aside-in">
    ...
    <?php endif; ?>
<div class="ArashJanPHP"><?php $content_column_class='class="col-sm-12"';?></div>
    <section<?php print $content_column_class; ?>>
      ...
      <?php if (!empty($title)): ?>
        ...
        <div class="row">
          <div class="col-xs-10 col-xs-offset-1 label-title text-center">
            Share your personal images, videos, and writings about being labeled <a href="http://droplabels.org/help">here</a>.
          </div>
        </div>
      </div>
